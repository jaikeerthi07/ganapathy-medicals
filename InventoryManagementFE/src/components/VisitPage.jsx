...
const VisitBillPage = () => {
  ...
  const fetchBills = async () => {
    ...
    try {
      ...
      // Filter to show only bills with bill numbers starting with "BT" or "AM"
      const btBills = processedBills.filter(bill => 
        bill.billNumber && (
          bill.billNumber.toUpperCase().startsWith('BT') || 
          bill.billNumber.toUpperCase().startsWith('AM')
        )
      );
