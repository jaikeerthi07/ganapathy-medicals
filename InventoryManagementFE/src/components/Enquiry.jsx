    ...
    <div style={modalStyles.overlay}>
      <div style={modalStyles.box}>
        ...
        <div style={modalStyles.grid}>
          ...
          <div style={modalStyles.group}>
            <label style={modalStyles.label}>Medicine/Requirement</label>
            <input style={modalStyles.input} value={form.medicine_interest || ""}
              onChange={(e) => set("medicine_interest", e.target.value)} placeholder="e.g. Paracetamol, Insulin, etc." />
          </div>
      ...
      {loading ? (
        ...
        <div style={pageStyles.tableWrapper}>
          <table style={pageStyles.table}>
            <thead>
              <tr>
                {["Patient/Customer", "Contact", "Email", "Requirement", "Meet-up Date", "Coming Today?", "Status", "Called", "Next Follow-up", "Actions"].map((h) => (
              ...
              {filtered.map((e) => {
                ...
                return (
                  <tr key={e.id} className="enquiry-row" style={{
                    ...
                    <td style={pageStyles.td}>{e.medicine_interest ? <><FaBriefcase style={{ color: "#22c55e", marginRight: 5 }} />{e.medicine_interest}</> : "—"}</td>
                    <td style={pageStyles.td}>
...
// ─────────────────────── Styles ───────────────────────
const pageStyles = {
  container: { padding: "20px", animation: "fadeIn 0.4s ease", color: "#fff", minHeight: "100vh", backgroundColor: "#000", borderRadius: "16px" },
  pageHeader: {
  ...
  tableWrapper: { overflowX: "auto", borderRadius: 16, border: "1px solid rgba(255,255,255,0.1)", background: "rgba(255,255,255,0.02)" },
  table: { width: "100%", borderCollapse: "collapse", fontSize: 14 },
  th: {
    background: "rgba(255,255,255,0.08)", color: "#94a3b8", fontWeight: 600,
