...
const Header = ({ toggleSidebar, isOpen }) => {
  ...
  return (
    <div style={{...styles.header, paddingLeft: isOpen ? "320px" : "80px"}}>
      {/* Left */}
                        ...
                        <div key={n.id} style={{ ...styles.notifItem, background: cfg.bg, borderLeft: `3px solid ${cfg.color}` }}>
                          <div style={{ flex: 1 }}>
                            ...
                            <div style={{ display: "flex", alignItems: "center", gap: 6, color: "#9ca3af", fontSize: 12 }}>
                              ...
                              {n.medical_interest && (
                                <span style={{ color: "#a855f7", marginLeft: 6 }}>💊 {n.medical_interest}</span>
                              )}
                            </div>
                          </div>
...
const styles = {
  ...
  toggleBtn: { cursor: "pointer", fontSize: "20px", color: "#10b981" },
  ...
  viewAllBtn: {
    width: "100%", background: "linear-gradient(135deg, rgba(16, 185, 129, 0.1), #a855f722)",
