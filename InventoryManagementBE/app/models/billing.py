...
class Bill(db.Model):
    ...
    doctor_reg_no = db.Column(db.String(50))
    patient_age = db.Column(db.Integer)
    patient_gender = db.Column(db.String(20))
    prescription_image = db.Column(db.Text)  # Base64 string of prescription
    is_prescription_verified = db.Column(db.Boolean, default=False)
    ...
    def to_dict(self):
        return {
            ...
            'patient': {
                ...
                'doctorRegNo': self.doctor_reg_no,
                'age': self.patient_age,
                'gender': self.patient_gender,
                'prescriptionImage': self.prescription_image,
                'isPrescriptionVerified': self.is_prescription_verified
            },
            'summary': {
