...
print("============================================================")
print("[FILE] FILE UPLOAD CONFIGURATION")
print(f"[FILE] Base directory: {BASE_DIR}")
print(f"[FILE] Upload folder path: {UPLOAD_FOLDER}")
print(f"[FILE] Upload folder absolute: {os.path.abspath(UPLOAD_FOLDER)}")
print(f"[FILE] Upload folder exists: {os.path.exists(UPLOAD_FOLDER)}")
print(f"[FILE] Current working directory: {os.getcwd()}")
print("============================================================")
...
def upload_file():
    ...
    try:
        ...
        if 'file' not in request.files:
            print("[ERROR] Error: No file part in request")
            return jsonify({'error': 'No file part'}), 400
        
        file = request.files['file']
        
        if file.filename == '':
            print("[ERROR] Error: No selected file")
            return jsonify({'error': 'No selected file'}), 400
        
        print(f"[FILE] File received: {file.filename}")
        print(f"[FILE] File content type: {file.content_type}")
        
        # Validate file type
        if not allowed_file(file.filename):
            print(f"[ERROR] Error: File type not allowed: {file.filename}")
        ...
        if os.path.exists(file_path):
            ...
            print(f"[SUCCESS] File saved successfully to: {file_path}")
...
def get_uploaded_file(filename):
    ...
    try:
        ...
        if '..' in filename or filename.startswith('/'):
            print("[ERROR] Security: Invalid filename")
        ...
        print(f"[FIND] Looking for file at: {abs_path}")
        print(f"[FILE] Upload folder exists? {os.path.exists(UPLOAD_FOLDER)}")
        ...
        if not os.path.exists(file_path):
            ...
            if os.path.exists(UPLOAD_FOLDER):
                ...
                print(f"[LIST] Files in upload folder ({len(files)}):")
        ...
        print(f"[SUCCESS] File found, serving: {abs_path}")
...
def delete_file():
    ...
    try:
        ...
        print("=" * 50)
        print("[DELETE] POST /api/delete-file called")
        
        data = request.get_json()
        if not data:
            print("[ERROR] Error: No data provided")
            return jsonify({'error': 'No data provided'}), 400
            
        file_path = data.get('filePath')
        if not file_path:
            print("[ERROR] Error: No file path provided")
        ...
        if os.path.exists(full_path) and os.path.isfile(full_path):
            os.remove(full_path)
            print(f"[SUCCESS] File deleted successfully: {abs_path}")
            return jsonify({
                'success': True,
        ...
        print(f"[ERROR] File delete error: {str(e)}")
        print(traceback.format_exc())
        return jsonify({'error': str(e)}), 500
...
def test_route():
    ...
    try:
        ...
        print(f"[TEST] Test route called with method: {request.method}")
...
def check_session():
    ...
    try:
        ...
        print(f"[AUTH] Check session called with method: {request.method}")
...
def get_suppliers():
    ...
    try:
        ...
        print("[LIST] GET /api/suppliers called")
...
def get_supplier(supplier_id):
    ...
    try:
        ...
        print(f"[USER] GET /api/suppliers/{supplier_id} called")
...
def create_supplier():
    ...
    try:
        ...
        print("=" * 50)
        print("[ADD] POST /api/suppliers called")
        ...
        print(f"[SUCCESS] Supplier created with ID: {new_supplier.id}")
...
def update_supplier(supplier_id):
    ...
    try:
        ...
        print(f"[EDIT] PUT /api/suppliers/{supplier_id} called")
        ...
        print(f"[SUCCESS] Supplier {supplier_id} updated successfully")
...
def delete_supplier(supplier_id):
    ...
    try:
        ...
        print(f"[DELETE] DELETE /api/suppliers/{supplier_id} called")
        ...
        print(f"[SUCCESS] Supplier {supplier_id} deleted successfully")
...
def get_supplier_items(supplier_id):
    ...
    try:
        ...
        print(f"[BULK] GET /api/suppliers/{supplier_id}/items called")
...
def get_item(item_id):
    ...
    try:
        ...
        print(f"[FIND] GET /api/items/{item_id} called")
...
def create_item(supplier_id):
    ...
    try:
        ...
        print("=" * 50)
        print(f"[ADD] POST /api/suppliers/{supplier_id}/items called")
        ...
        new_item = Item(
            ...
            quantity=int(data.get('quantity', 0))  # [SUCCESS] FIXED: Include quantity
        )
        ...
        print(f"[SUCCESS] Item created with ID: {new_item.id}")
        print("=" * 50)
...
def update_item(item_id):
    ...
    try:
        ...
        print(f"[EDIT] PUT /api/items/{item_id} called")
        ...
        if 'quantity' in data:  # [SUCCESS] FIXED: Include quantity
            item.quantity = int(data['quantity']) if data['quantity'] else 0
        
        item.updated_at = datetime.utcnow()
        db.session.commit()
        
        print(f"[SUCCESS] Item {item_id} updated successfully. New quantity: {item.quantity}")
...
def delete_item(item_id):
    ...
    try:
        ...
        print(f"[DELETE] DELETE /api/items/{item_id} called")
        ...
        if item.attachment:
            try:
                ...
                if os.path.exists(file_path) and os.path.isfile(file_path):
                    os.remove(file_path)
                    print(f"[FILE] Attachment file deleted: {file_path}")
            except Exception as e:
...
def get_suppliers_with_items():
    ...
    try:
        ...
        print("[LIST] GET /api/suppliers-with-items called")
...
def bulk_create_items():
    ...
    try:
        ...
        print("[BULK] POST /api/items/bulk called")
        ...
        for idx, item_data in enumerate(items_data):
            try:
                ...
                new_item = Item(
                    ...
                    quantity=int(item_data.get('quantity', 0))  # [SUCCESS] FIXED: Include quantity
                )
        ...
        if created_items:
            db.session.commit()
            print(f"[SUCCESS] {len(created_items)} items created successfully")
...
def bulk_update_items():
    ...
    try:
        ...
        print("[STOCK] POST /api/items/bulk-update called")
        ...
        for item_data in items_data:
            try:
                ...
                if 'quantity' in item_data:  # [SUCCESS] FIXED: Include quantity
        ...
        if updated_items:
            db.session.commit()
            print(f"[SUCCESS] {len(updated_items)} items updated successfully")
...
def bulk_delete_suppliers():
    ...
    try:
        ...
        print("[DELETE] POST /api/suppliers/bulk-delete called")
        ...
        print(f"[SUCCESS] {deleted_count} suppliers deleted successfully")
